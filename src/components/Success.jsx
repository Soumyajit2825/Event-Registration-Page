    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center h-[100vh] w-full overflow-hidden bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500">
                ...
                <h3 className='bg-white p-3 text-center rounded-xl mt-20 md:text-2xl text-md text-black font-bold border-black border-4 hover:scale-[1.05]' >Please Collect Your Payment Recipt from Canteen.<br/> Please Check The Team Lead's Email for further updates.</h3>
